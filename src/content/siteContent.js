    ...
    routeCards: [
      {
        ...
        to: '/profile',
        title: '\u57fa\u672c\u80cc\u666f',
        description: '\u8fd9\u91cc\u4ecb\u7ecd\u6211\u7684\u57fa\u672c\u4fe1\u606f\u548c\u5174\u8da3\u7231\u597d\u3002',
      },
      {
        label: '\u5b66\u672f\u7ecf\u5386',
        to: '/experience',
        title: '\u5b66\u672f\u7ecf\u5386',
        description: '\u4e86\u89e3\u6211\u7684\u79d1\u7814\u3001\u5de5\u4f5c\u53ca\u9879\u76ee\u7ba1\u7406\u7ecf\u5386\u3002',
      },
      {
        label: '\u821e\u8e48\u89c6\u9891',
        to: '/dance',
        title: '\u821e\u8e48\u89c6\u9891',
        description: '\u8857\u821e\u6bd4\u8d5b\u548c\u6f14\u51fa\u89c6\u9891\u3002',
      },
      {
        label: '\u8054\u7cfb\u65b9\u5f0f',
        to: '/contact',
  ...
  zh: {
    ...
    cards: [
      ...
      },
      {
        ...
        title: '\u5fae\u4fe1',
        value: 'XZQqqqqqian',
        description: '\u8fd9\u662f\u6211\u5e38\u7528\u7684\u793e\u4ea4\u8f6f\u4ef6\u3002\u5982\u679c\u4f60\u60f3\u52a0\u6211\u4e3a\u597d\u53cb\uff0c\u53ef\u4ee5\u70b9\u51fb\u67e5\u770b\u4e8c\u7ef4\u7801\u3002',
        type: 'modal',
      },
    ],
    wechatModal: {
  ...
  const localizedActivity = [
    {
      ...
      bullets: [
        ...
        '协助学校策划和执行运动会、校园艺术节等大型活动，承担活动总体策划等核心协调工作。',
    ...
    },
    {
      ...
      bullets: [
        ...
        '主要负责商店的人员协调，包括排班、通知发布、会议纪要以及日常团队管理。',
      ],
    ...
    },
    {
      ...
      role: '行政实习生',
      bullets: [
        '通过校园热线为在校生、家长和校友提供支持，协调处理外部合作机构的咨询，并解答有关学籍和档案流程的问题。',
    ...
    },
    {
      ...
      bullets: [
        ...
        '组织并完成 Shuffle Crew 年度专场演出，在整个制作周期内统筹多个节目，并参与相关演出。',
        '代表团队与校内外组织沟通，通过合作洽谈、联合主办和现场演出支持，协助联合活动顺利开展。',
        '我在校园专场中的一段即兴表演视频在抖音获得超过500万次播放和7万次点赞，提升了个人表演和团队的曝光度。',
      ],
...
export const profilePageContent = {
  ...
  zh: {
    hero: {
      ...
      title: '个人概况',
      lead:
        '这里介绍我的基本信息、教育背景和兴趣爱好。如果你想了解我的学术或舞蹈经历，可以点击下方按钮进入相应页面。',
    ...
    campus: {
      ...
      title: '校园经历',
      intro:
        '以下是我在校期间参与的部分活动，体现了我的领导力、沟通能力、创新能力等综合素养。部分经历还可以点击打开照片图库，了解更多细节。',
    ...
    offCampus: {
      ...
      empty: {
        label: '模块已就绪',
        title: '在这里添加你的校外经历',
        description: '校外经历模块已预留，后续将补充具体内容。',
      },
    },
    photos: {
      eyebrow: '照片',
...
export const researchExperience = [
  {
    ...
    publicationStatusZh: '目前以第二作者身份投稿至 CVIU（CCF B 类）',
    publicationStatusZhOverride: '目前以第二作者身份投稿至 CVIU（CCF B 类）',
    sortValue: 202505,
  },
  {
...
export const workingExperience = [
  {
    company: 'Pony.ai',
    companyZh: '小马智行',
    role: 'Algorithm Intern | AI Department',
    roleZh: '算法实习生 | 人工智能部',
    period: 'July 2026 - Sep 2026',
    periodZh: '2026年7月 - 2026年9月',
    ...
    bulletsZhOverride: [
      ...
      '独立开发了一款 4D Gaussian Splatting（4DGS）点云编辑与对比工具，目前已被小马智行使用；此外还研究了智能体辅助开发实践，编写相关文档并规范公司对 harness、loop engineering 等工作流的使用，从而提升开发效率。',
    ],
    bulletLinkIndex: 2,
    bulletLinkHref: 'https://github.com/qianqqqqqXZQ/4DGS-Edit-and-Compare',
    bulletLinkLabel: 'View the 4DGS tool on GitHub',
    bulletLinkLabelZh: '在 GitHub 查看 4DGS 工具',
    sortValue: 202607,
  },
]
